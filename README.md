### The source code provided here implements the methods described in the paper "Developing a hybrid convolutional neural network for automatic aphid counting in sugar beet fields"
please get access all the codes and datasets in the folder of `./Automatic_aphid_counting/`

This repos is also related to https://github.com/JunfengGaolab/Counting-Aphids
...
## ✨ New Release ✨ 
We have launched an online test application for automatic aphid counting using our proposed method, now accessible on the Hugging Face platform:
👉 https://huggingface.co/spaces/XuminGao/Aphid-Counting
